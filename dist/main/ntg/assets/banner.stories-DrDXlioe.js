...
${e.map((e,t)=>{let i=t===n;return`        <li class="${`breadcrumb-item${i?` active`:``}`}"${i?` aria-current="page"`:``}>${i?`<span class="content-breadcrumbs__current" data-sq-field="label">${r(e.label)}</span>`:`<a class="content-breadcrumbs__link" href="${r(e.href??`#`)}" data-sq-field="label">${r(e.label)}</a>`}</li>`}).join(`
`)}
        </ol>
      </nav>
    </div>`}function o(e,t,n){if(!e)return``;let i=t&&n?` <a href="${r(n)}" class="banner__description-link" data-sq-field="descriptionLinkText">${r(t)}</a>`:``;return`<p class="banner__description" data-sq-field="description">${r(e)}${i}</p>`}function s(e,t,n){if(!e)return``;let a=i(n);return`
          <div class="banner__cta">
            ${t?`<a href="${r(t)}" class="${a}" data-sq-field="ctaText">${r(e)}</a>`:`<button type="button" class="${a}" data-sq-field="ctaText">${r(e)}</button>`}
          </div>`}function c(){return`
      <div class="banner__decorative" aria-hidden="true">
        ${m}
      </div>`}function l(e,t,n){if(!e||!t||t.length===0||!p.has(e))return``;let i;return n?(i=t.map(e=>`            <a href="${r(e.href)}" class="banner__link" data-sq-field="label">${r(e.label)}</a>`).join(`
`),i=`
          <div class="banner__links-vertical">
${i}
          </div>`):(i=t.map(e=>`            <a href="${r(e.href)}" class="banner__pill-link" data-sq-field="label">${r(e.label)}</a>`).join(`
`),i=`
...
<div class="fullwidth ${A}" data-variant="${T}">
  ${O?c():``}
      <div class="banner__container">
        ${a(k)}
        <div class="banner__content">
          <div class="banner__main">
            <h1 class="banner__title" data-sq-field="title">${r(n)}</h1>
            ${o(i,m,h)}
            ${j?M:``}
          </div>
          ${N}
...
//# sourceMappingURL=banner.stories-DrDXlioe.js.map