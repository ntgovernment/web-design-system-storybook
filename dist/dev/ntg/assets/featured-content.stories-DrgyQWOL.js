import{n as e}from"./chunk-BVpWp9h4.js";import{n as t,t as n}from"./component.helper-COp5GpYY.js";import{n as r,t as i}from"./squizStoryRenderer-4zIdV6yt.js";import{n as a,r as o,t as s}from"./xss-Cvy76lHc.js";import{n as c,t as l}from"./squizInfo.mock-x2sHGyES.js";function u(e){return!e||typeof e!=`object`?null:`data`in e?e.data??null:e}async function d(e,t){if(!e||typeof t?.resolveUri!=`function`)return null;try{return u(await t.resolveUri(e))}catch{return null}}function f(e){if(!e)return null;let t=e.imageVariations?.original||{};if(t.url)return{url:t.url,alt:e.alt||e.name||``};let n=e.url||(Array.isArray(e.urls)?e.urls[0]:``)||``;return n?{url:n,alt:e.alt||e.name||``}:null}var p,m,h,g,_,v=e((()=>{o(),t(),p=`<svg viewBox="0 0 16 16" width="16" height="16" fill="none" aria-hidden="true" focusable="false"><path d="M3 8h10m0 0-4-4m4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,m=`Read more`,h=new Set([`Left`,`Right`]),g=new Set([`White`,`Gray`]),_={async main(e={},t={}){let{image:r=``,imagePosition:i=`Right`,background:o=`White`,border:c=!0,linkAsset:l=``,body:u=``}=e,_=h.has(i)?i:`Right`,v=g.has(o)?o:`White`,[y,b]=await Promise.all([d(r,t.fns),d(l,t.fns)]),x=f(y),S=b?.name||``,C=b?.url||``,w=x?`<img class="featured-content__image" src="${a(x.url)}" alt="${s(x.alt)}" loading="lazy" />`:``,T=u?`<div class="featured-content__body" data-sq-field="body">${u}</div>`:``,E=C?`<a class="featured-content__link" href="${a(C)}">${s(m)} <span class="featured-content__link-icon">${p}</span></a>`:``;return`
...
//# sourceMappingURL=featured-content.stories-DrgyQWOL.js.map