import{n as e}from"./chunk-BVpWp9h4.js";import{n as t,t as n}from"./component.helper-D0vBjeOt.js";import{n as r,t as i}from"./squizStoryRenderer-4zIdV6yt.js";import{n as a,r as o,t as s}from"./xss-Cvy76lHc.js";import{n as c,t as l}from"./squizInfo.mock-D4VTpLG1.js";function u(e){return e?`matrix-asset://${x}/${e}`:``}async function d(e,t){if(!e||typeof t?.resolveUri!=`function`)return null;try{return f(await t.resolveUri(e))}catch{return null}}function f(e){return!e||typeof e!=`object`?null:`data`in e?e.data??null:e}function p(e,t){let n=e?.[t];return Array.isArray(n)&&n[0]||``}function m(e,t){let n=e?.[t];return Array.isArray(n)?n:[]}async function h(e,t){if(!e||!t)return[];let n=`${t}?${b}=${encodeURIComponent(e)}`;try{let e=await fetch(n);if(!e.ok)return[];let t=await e.json();return Array.isArray(t)?t:[]}catch{return[]}}function g(e,t,n){if(!e||!e.url)return null;let r=!!t&&String(e.id)===String(t);return{label:e.name||``,href:e.url,current:r,children:r?n.map(_).filter(Boolean):[]}}function _(e){return!e||!e.url?null:{label:e.name||``,href:e.url}}function v(e,t,n){return`
...
//# sourceMappingURL=side-navigation.stories-DShXLe-Y.js.map