...
`)}
    ...
    </div>`}function te(e,t){if(!e)return``;let n=t?` <a href="${o(t.url)}" class="banner__description-link" data-sq-field="descriptionLink"${c(t.target)}>${o(t.text)}</a>`:``;return`<p class="banner__description" data-sq-field="description">${o(e)}${n}</p>`}function ne(e,t){if(!e)return``;let n=l(t);return`
          <div class="banner__cta">
            ${`<a href="${o(e.url)}" class="${n}" data-sq-field="cta"${c(e.target)}>${o(e.text)}</a>`}
...
${r}
    ...
    </svg>`,m={async main(e){let{variant:t=`primary`,title:i=``,description:a=``,descriptionLink:c,cta:l,ctaVariant:p,linksHeading:m=``,links:h=[],breadcrumbs:g=[],label:_=``,href:v=``,visibilityOptions:y={}}=e||{},{showCta:b,showDecorative:x}=y||{},S=s(c),C=s(l),w=r(`banner`,n(e,[`fullwidth background`])),T=u.has(t)?t:`primary`,E=T===`secondary`,D=p&&d.has(p)?p:`secondary`,O=x===void 0?!0:!!x,k=b===void 0?!0:!!b,A=[];Array.isArray(g)&&g.length>0?A=g:_&&v&&(A=[{label:_,href:v},{label:`Current page`,isCurrent:!0}]);let j=`banner--${T}`,M=(Array.isArray(h)?h:[]).map(e=>s(e?.link)).filter(Boolean),N=!!m&&f.has(m)&&M.length>0,P=k?ne(C,D):``,F=N?ie(m,M,E):k&&C?ae(P):``;return`
<div ${w} class="${j}" data-variant="${T}">
  ${O?re():``}
...
`}}})),g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,oe;await e((async()=>{a(),h(),g=i(m.main),_={title:`dxp components/Banner`,parameters:{layout:`fullscreen`}},v={variant:`primary`,title:`Page title`,description:`Optional short description of the page goal`,cta:{text:`Call to action`,url:`#`},linksHeading:`Popular`,links:[{link:{text:`Bus timetables and maps`,url:`#`}},{link:{text:`Check your rego`,url:`#`}},{link:{text:`Find a Motor Vehicle Registry (MVR)`,url:`#`}},{link:{text:`Government priorities`,url:`#`}}]},y=await g.markup(v),b={render:e=>g(e),args:v,argTypes:{variant:{control:`select`,options:[`primary`,`secondary`]},title:{control:`text`},description:{control:`text`},descriptionLink:{control:`object`,description:`SquizLink -- Asset Tree pick or a manual URL. Optional inline link appended to the description text; blank/unset omits it.`},cta:{control:`object`,description:`SquizLink -- Asset Tree pick or a manual URL. Blank/unset hides the button.`},ctaVariant:{control:`select`,options:[`primary`,`secondary`,`tertiary`]},linksHeading:{control:`select`,options:[`Popular`,`Featured`,`Related`]},links:{control:`object`,description:`Array of { link: SquizLink } items -- each link is an Asset Tree pick or a manual URL.`},breadcrumbs:{control:`object`},label:{control:`text`,description:`Breadcrumb parent label shortcut (e.g. "Home").`},href:{control:`text`,description:`Breadcrumb parent URL shortcut.`},visibilityOptions:{control:`object`}},parameters:{docs:{source:{code:y,language:`html`,type:`code`}}}},x={variant:`secondary`,title:`Page title`,description:`Optional short description of the page goal`,cta:{text:`Call to action`,url:`#`},linksHeading:`Popular`,links:[{link:{text:`Bus timetables and maps`,url:`#`}},{link:{text:`Check your rego`,url:`#`}},{link:{text:`Find a Motor Vehicle Registry (MVR)`,url:`#`}},{link:{text:`Government priorities`,url:`#`}}],label:`Home`,href:`/`},S=await g.markup(x),C={render:()=>g(x),parameters:{docs:{source:{code:S,language:`html`,type:`code`}}}},w={variant:`primary`,title:`Northern Territory Government Services and Information Portal`,description:`Access comprehensive information about Northern Territory Government services, programs, and initiatives. Whether you're a resident, business owner, or visitor, find everything you need to interact with government services online.`,cta:{text:`Get started with services`,url:`#`},ctaVariant:`secondary`,linksHeading:`Popular`,links:[{link:{text:`Driver's license renewal and applications`,url:`#`}},{link:{text:`Business registration and licensing`,url:`#`}},{link:{text:`Property and land information services`,url:`#`}},{link:{text:`Health and community programs`,url:`#`}},{link:{text:`Education and training resources`,url:`#`}}],breadcrumbs:[{label:`Home`,href:`/`},{label:`About`,href:`/about`},{label:`Services portal`,isCurrent:!0}],visibilityOptions:{showDecorative:!0}},T=await g.markup(w),E={render:()=>g(w),parameters:{docs:{source:{code:T,language:`html`,type:`code`}}}},D={variant:`primary`,title:`Health and Wellbeing`,description:`Access health services, find medical facilities, and learn about public health programs in the Northern Territory.`,cta:{text:`Find health services`,url:`#`},linksHeading:`Featured`,links:[{link:{text:`COVID-19 information`,url:`#`}},{link:{text:`Mental health support`,url:`#`}},{link:{text:`Hospital locations`,url:`#`}},{link:{text:`Medicare services`,url:`#`}}],label:`Home`,href:`/`},O=await g.markup(D),k={render:()=>g(D),parameters:{docs:{source:{code:O,language:`html`,type:`code`}}}},A={variant:`primary`,title:`Business and Industry`,description:`Start a business, apply for licenses and permits, and access business support services.`,cta:{text:`Register your business`,url:`#`},linksHeading:`Related`,links:[{link:{text:`Business grants`,url:`#`}},{link:{text:`Trade licenses`,url:`#`}},{link:{text:`Industry regulations`,url:`#`}},{link:{text:`Export assistance`,url:`#`}}],label:`Home`,href:`/`},j=await g.markup(A),M={render:()=>g(A),parameters:{docs:{source:{code:j,language:`html`,type:`code`}}}},N={variant:`secondary`,title:`Transport Services`,description:`Access public transport information, vehicle registration, and licensing services.`,cta:{text:`View all transport services`,url:`#`},linksHeading:`Featured`,links:[{link:{text:`Renew your driver's license`,url:`#`}},{link:{text:`Register a vehicle`,url:`#`}},{link:{text:`Road safety information`,url:`#`}},{link:{text:`Public transport timetables`,url:`#`}},{link:{text:`Apply for driving permit`,url:`#`}}],breadcrumbs:[{label:`Home`,href:`/`},{label:`Services`,href:`/services`},{label:`Transport`,isCurrent:!0}]},P=await g.markup(N),F={render:()=>g(N),parameters:{docs:{source:{code:P,language:`html`,type:`code`}}}},I={variant:`primary`,title:`Clean Banner Design`,description:`This banner demonstrates the component without decorative background elements.`,cta:{text:`Learn more`,url:`#`},visibilityOptions:{showDecorative:!1},linksHeading:`Popular`,links:[{link:{text:`Service 1`,url:`#`}},{link:{text:`Service 2`,url:`#`}},{link:{text:`Service 3`,url:`#`}}]},L=await g.markup(I),R={render:()=>g(I),parameters:{docs:{source:{code:L,language:`html`,type:`code`}}}},z={variant:`primary`,title:`Banner Without a Call to Action`,description:`This banner demonstrates the component with the call to action button hidden.`,cta:{text:`Learn more`,url:`#`},visibilityOptions:{showCta:!1},linksHeading:`Popular`,links:[{link:{text:`Service 1`,url:`#`}},{link:{text:`Service 2`,url:`#`}},{link:{text:`Service 3`,url:`#`}}]},B=await g.markup(z),V={render:()=>g(z),parameters:{docs:{source:{code:B,language:`html`,type:`code`}}}},H={variant:`secondary`,title:`Community Consultation Opens for Major Project`,description:`Residents are invited to provide feedback on proposed infrastructure improvements in the greater Darwin area.`,descriptionLink:{text:`Read the full announcement`,url:`#`},cta:{text:`Have your say`,url:`#`},linksHeading:`Popular`,links:[{link:{text:`Bus timetables and maps`,url:`#`}},{link:{text:`Check your rego`,url:`#`}}],label:`Home`,href:`/`},U=await g.markup(H),W={render:()=>g(H),parameters:{docs:{source:{code:U,language:`html`,type:`code`}}}},G={variant:`secondary`,title:`Page title`,description:`Optional short description of the page goal`,visibilityOptions:{showDecorative:!1}},K=await g.markup(G),q={render:()=>g(G),parameters:{docs:{source:{code:K,language:`html`,type:`code`}}}},J={variant:`secondary`,title:`Publication title`,description:`Optional short description of the publication or resource, summarising what it covers and who it's for.`,cta:{text:`Download the report (PDF)`,url:`#`},breadcrumbs:[{label:`Home`,href:`/`},{label:`Publications`,href:`/publications`},{label:`Current page`,isCurrent:!0}],visibilityOptions:{showDecorative:!1}},Y=await g.markup(J),X={name:`With CTA`,render:()=>g(J),parameters:{docs:{source:{code:Y,language:`html`,type:`code`}}}},Z={variant:`primary`,title:`Manually-Typed Links`,description:`The CTA and every panel link below are manually-typed URLs (no assetId), not Asset Tree picks.`,cta:{text:`Manual CTA link`,url:`https://example.com/manual-cta-url`},linksHeading:`Popular`,links:[{link:{text:`Manual link one`,url:`https://example.com/manual-link-one`}},{link:{text:`Manual link two`,url:`https://example.com/manual-link-two`}}]},Q=await g.markup(Z),$={render:()=>g(Z),parameters:{docs:{description:{story:"`cta` and `links[].link` each set as a { text, url } object with no `assetId` -- SquizLink's manual-entry path, as opposed to an Asset Tree pick."},source:{code:Q,language:`html`,type:`code`}}}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  ...
  argTypes: {
    ...
    links: {
      control: 'object',
      description: 'Array of { link: SquizLink } items -- each link is an Asset Tree pick or a manual URL.'
    },
    breadcrumbs: {
      control: 'object'
    },
  ...
  parameters: {
    docs: {
      description: {
        story: '\`cta\` and \`links[].link\` each set as a { text, url } object with no \`assetId\` -- SquizLink\\'s manual-entry path, as opposed to an Asset Tree pick.'
      },
      source: {
...
}`,...$.parameters?.docs?.source}}},oe=[`Primary`,`Secondary`,`Complete`,`PrimaryFeatured`,`PrimaryRelated`,`SecondaryFeatured`,`WithoutDecorative`,`WithoutCta`,`WithDescriptionLink`,`Minimal`,`WithCta`,`WithManualLinks`]}))();export{E as Complete,q as Minimal,b as Primary,k as PrimaryFeatured,M as PrimaryRelated,C as Secondary,F as SecondaryFeatured,X as WithCta,W as WithDescriptionLink,$ as WithManualLinks,V as WithoutCta,R as WithoutDecorative,oe as __namedExportsOrder,_ as default};
//# sourceMappingURL=banner.stories-C3VJG2MA.js.map