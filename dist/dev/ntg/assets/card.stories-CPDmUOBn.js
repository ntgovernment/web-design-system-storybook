...
<div ${t} class="news-cards">
  <div class="news-cards__header">
    <h2 class="news-cards__title">${c(b)}</h2>
...
`}async function me(e,t,n){let r=await te(t,n),i=Array.isArray(e)?e:[],a=new Set;return[...i,...r].filter(e=>a.has(e)?!1:(a.add(e),!0))}var _,v,y,b,x,S,C,w,T,he=e((()=>{s(),n(),_=`<svg viewBox="0 0 16 16" width="16" height="16" fill="none" aria-hidden="true" focusable="false"><path d="M3 8h10m0 0-4-4m4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,v=`Find out more`,y=`News`,b=`What we are doing`,x=`View all`,S=3,C=`%globals_site_metadata_site-news^as_asset:asset_url%`,w=`rootId`,T={async main(e={},t={}){let{cardMode:n=`Display Cards`,assets:i=[],parentAsset:a=``,visibilityOptions:o={}}=e,{showImage:s=!0,showTags:c=!0,showDate:l=!0}=o,u=await me(i,a,t.env?.CONTENT_API_URL),d=r(`card`,e),f={showImage:s,showTags:c,showDate:l};return n===`Mini Cards`?`
...
}`,...$.parameters?.docs?.source}}},_e=[`SinglePage`,`MultiplePages`,`Unresolvable`,`HomepageCards`,`MiniCards`,`MiniCardsNoLink`,`NewsCards`]}))();export{G as HomepageCards,J as MiniCards,Z as MiniCardsNoLink,z as MultiplePages,$ as NewsCards,I as SinglePage,H as Unresolvable,_e as __namedExportsOrder,N as default};
//# sourceMappingURL=card.stories-CPDmUOBn.js.map