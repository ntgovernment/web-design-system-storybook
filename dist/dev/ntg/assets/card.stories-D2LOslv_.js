import{n as e}from"./chunk-BVpWp9h4.js";import{t}from"./card-DCcP7Xt5.js";import{n,t as r}from"./component.helper-D0vBjeOt.js";import{n as i,t as a}from"./squizStoryRenderer-4zIdV6yt.js";import{n as o,r as s,t as c}from"./xss-Cvy76lHc.js";import{n as l,t as u}from"./squizInfo.mock-x2sHGyES.js";function d(e){return!e||typeof e!=`object`?null:`data`in e?e.data??null:e}async function f(e,t){if(!e||typeof t?.resolveUri!=`function`)return null;try{return d(await t.resolveUri(e))}catch{return null}}function p(e){let t=/^matrix-asset:\/\/([a-zA-Z0-9.-]+)\/\d+(?::.+)?$/.exec(String(e??``));return t?t[1]:null}function m(e){let t=/^matrix-asset:\/\/[a-zA-Z0-9.-]+\/(\d+)(?::.+)?$/.exec(String(e??``));return t?t[1]:null}function ee(e){return e?typeof e==`string`?{url:e,text:e,target:`_self`}:typeof e==`object`&&e.url?{url:e.url,text:e.text||e.url,target:e.target||`_self`}:null:null}function h(e){return e&&e!==`_self`?` target="${c(e)}" rel="noopener noreferrer"`:``}async function g(e,t){let n=p(e),r=m(e);if(!n||!r||!t)return[];let i=`${t}?${ve}=${encodeURIComponent(r)}`,a;try{let e=await fetch(i);if(!e.ok)return[];a=await e.json()}catch{return[]}return Array.isArray(a)?a.map(e=>e?.id).filter(Boolean).map(e=>`matrix-asset://${n}/${e}`):[]}async function _(e,t,n){let r=v(e.metadata||{},`content-cardImagePhoto`);if(r){let e=/^matrix-asset:\/\//.test(r)?r:t?`matrix-asset://${t}/${r}`:null,i=e?await f(e,n):null,a=i?.url||(Array.isArray(i?.urls)?i.urls[0]:``)||``;if(a)return{url:a,alt:i.name||``,width:null,height:null}}let i=e.thumbnail;return i?{url:i.url||``,alt:i.alt||i.title||``,width:i.width||null,height:i.height||null}:null}function v(e,t){let n=e?.[t];return Array.isArray(n)&&n[0]||``}async function y(e,t,n){if(!e)return null;let r=e.metadata||{};return{title:v(r,`content-cardTitle`)||e.name||``,description:v(r,`content-cardDescription`),image:await _(e,t,n),date:v(r,`Date`),tagLabel:v(r,`Category`),href:e.url||``,actionText:v(r,`content-cardButtonText`)||he}}async function te(e,t){let n=Array.isArray(e)?e:[];return(await Promise.all(n.map(async e=>{let n=await y(await f(e,t),p(e),t);return n?[n]:[]}))).flat()}function ne(e,t){let n=t.showImage?e.image:null,r=t.showTags?e.tagLabel:``,i=t.showDate?e.date:``,a=`card-title-${Math.random().toString(36).slice(2,9)}`,s=n?`
    <div class="card__image">
      ...
      <div class="card__footer">
        <span class="card__action">${c(e.actionText)} <span class="card__action-icon">${me}</span></span>
      </div>`:``,f=`${s}
    ...
    <span class="mini-card__label">${c(n)}</span>`;return r?`<a class="mini-card" href="${o(r)}">${i}</a>`:`<div class="mini-card">${i}</div>`}async function le(e,t,n){if(!e)return null;let r=e.metadata||{};return{title:v(r,`content-cardTitle`)||e.name||``,description:v(r,`content-cardDescription`),image:await _(e,t,n),date:v(r,`news-datePublished`),href:e.url||``}}function S(e){let t=Date.parse(e||``);return Number.isNaN(t)?-1/0:t}async function ue(e,t){let n=Array.isArray(e)?e:[];return(await Promise.all(n.map(async e=>{let n=await le(await f(e,t),p(e),t);return n?[n]:[]}))).flat().sort((e,t)=>S(t.date)-S(e.date)).slice(0,_e)}function de(e,t){let n=t.showImage?e.image:null,r=t.showDate?e.date:``,i=`news-card-title-${Math.random().toString(36).slice(2,9)}`,a=n?`
    <div class="card__image">
      <img src="${o(n.url)}" alt="${c(n.alt)}"${n.width?` width="${n.width}"`:``}${n.height?` height="${n.height}"`:``} />
    </div>`:``,s=t.showDescription&&e.description?`<p class="card__description">${c(e.description)}</p>`:``,l=`${a}
    <div class="card__content">
      <div class="news-card__header">
        ${t.showTags?`<span class="card__tag">${c(ge)}</span>`:``}
...
`}}}));function xe({id:e,name:t,category:n,date:r,description:i,mockImage:a}){let o=``;a&&(o=`${e}9`,E[o]={id:o,type:`image`,name:`${t} photo`,url:`https://picsum.photos/id/${e}/640/480`,urls:[`https://picsum.photos/id/${e}/640/480`]});let s={id:String(e),type:`pageStandard`,name:t,url:`https://example.com/pages/${e}`,metadata:{Category:[n],Date:[r],"content-cardDescription":[i],...o?{"content-cardImagePhoto":[o]}:{}},child_count:0};return E[String(e)]=s,s}function C({id:e,name:t,icon:n,href:r}){let i={id:String(e),type:`dataRecord`,name:t,url:r,metadata:{"content-cardIcon":[n]},child_count:0};return E[String(e)]=i,i}function w({id:e,name:t,icon:n,description:r,href:i}){let a={id:String(e),type:`pageStandard`,name:t,url:i,metadata:{"content-cardIcon":[n],"content-cardDescription":[r]},child_count:0};return E[String(e)]=a,a}function T({id:e,name:t,date:n,description:r,href:i}){let a=`${e}9`;E[a]={id:a,type:`image`,name:`${t} photo`,url:`https://picsum.photos/id/${e}/640/480`,urls:[`https://picsum.photos/id/${e}/640/480`]};let o={id:String(e),type:`pageStandard`,name:t,url:i,metadata:{"content-cardDescription":[r],"content-cardImagePhoto":[a],"news-datePublished":[n]},child_count:0};return E[String(e)]=o,o}var E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,Se,U,W,Ce,G,K,we,q,J,Te,Y,X,Z,Q,$;await e((async()=>{a(),u(),t(),be(),E={},xe({mockImage:!0,id:1001,name:`Community Consultation Opens for Major Project`,category:`News`,date:`17 Feb 2025`,description:`Residents invited to provide feedback on proposed infrastructure improvements in the greater Darwin area.`}),xe({mockImage:!0,id:1003,name:`Grants Information Session`,category:`Event`,date:`2 Mar 2025`,description:`Join a free information session on the upcoming community grants round.`}),C({id:3101,name:`Grant applicants`,icon:`briefcase`,href:`#`}),C({id:3102,name:`Service providers`,icon:`earth-americas`,href:`#`}),C({id:3103,name:`Get in touch`,icon:`circle-info`,href:`#`}),C({id:3104,name:`No icon, no link`,icon:``,href:``}),w({id:2101,name:`Card title 1`,icon:`circle`,description:`Placeholder description text. Lorem ipsum dolor sit amet, consectetur adipiscing elit.`,href:`#`}),w({id:2102,name:`Card title 2`,icon:`square`,description:`Placeholder description text. Nam ac nunc neque, praesent posuere lobortis purus.`,href:`#`}),w({id:2103,name:`Card title 3`,icon:`star`,description:`Placeholder description text. Ac laoreet est volutpat in, vestibulum ante ipsum primis.`,href:`#`}),w({id:2104,name:`Card title 4`,icon:`bell`,description:`Placeholder description text. Sed do eiusmod tempor incididunt ut labore et dolore.`,href:`#`}),w({id:2105,name:`Card title 5`,icon:`gear`,description:`Placeholder description text. Ut enim ad minim veniam, quis nostrud exercitation.`,href:`#`}),T({id:4101,name:`News card title 1`,date:`10 Jun 2026`,description:`Placeholder description text. Lorem ipsum dolor sit amet, consectetur adipiscing elit.`,href:`#`}),T({id:4102,name:`News card title 2`,date:`26 Jun 2026`,description:`Placeholder description text. Nam ac nunc neque, praesent posuere lobortis purus.`,href:`#`}),T({id:4103,name:`News card title 3`,date:`1 Jun 2026`,description:`Placeholder description text. Ac laoreet est volutpat in, vestibulum ante ipsum primis.`,href:`#`}),w({id:6101,name:`Icon card title 1`,icon:`briefcase`,description:`Placeholder description text. Lorem ipsum dolor sit amet, consectetur adipiscing elit.`,href:`#`}),w({id:6102,name:`Icon card title 2`,icon:`book-open`,description:`Placeholder description text. Nam ac nunc neque, praesent posuere lobortis purus.`,href:`#`}),w({id:6103,name:`Icon card title 3`,icon:`books`,description:`Placeholder description text. Ac laoreet est volutpat in, vestibulum ante ipsum primis.`,href:`#`}),D=i(ye.main),O=l({mock:{resolveUri(e){return{ok:!0,data:E[/^matrix-asset:\/\/[a-zA-Z0-9.-]+\/(\d+)/.exec(String(e??``))?.[1]]??null}}}}),k={title:`dxp components/Card`},A={cardMode:`Display Cards`,assets:[`matrix-asset://ntg/1001`]},j=await D.markup(A,O),M={render:e=>D(e,O),args:A,argTypes:{assets:{control:`object`,description:`Array of matrix-asset-uri strings. Only these demo URIs resolve to anything in this Storybook preview (mocked): matrix-asset://ntg/1001, matrix-asset://ntg/1003.`}},parameters:{docs:{description:{story:`One selected asset -- one card, populated entirely from that asset's own metadata (title, description, image, date, category, url). Hover/tab-focus the card to see the hover/focus states.`},source:{code:j,language:`html`,type:`code`}}}},N={cardMode:`Display Cards`,assets:[`matrix-asset://ntg/1001`,`matrix-asset://ntg/1003`]},P=await D.markup(N,O),F={render:()=>D(N,O),parameters:{docs:{description:{story:`Multiple selected assets -- the grid is the union of every asset's card.`},source:{code:P,language:`html`,type:`code`}}}},I={cardMode:`Display Cards`,assets:[`matrix-asset://ntg/9999999`]},L=await D.markup(I,O),R={render:()=>D(I,O),parameters:{docs:{description:{story:`An asset that fails to resolve at all contributes nothing, rendering an empty grid rather than throwing.`},source:{code:L,language:`html`,type:`code`}}}},z={cardMode:`Display Cards Icons`,assets:[`matrix-asset://ntg/6101`,`matrix-asset://ntg/6102`,`matrix-asset://ntg/6103`]},B=await D.markup(z,O),V={render:()=>D(z,O),argTypes:{cardMode:{control:`radio`,options:[`Display Cards`,`Display Cards Icons`,`Homepage Cards`,`Mini Cards`,`News Cards`]},assets:{control:`object`,description:`Array of matrix-asset-uri strings. Icon/title/description are read from the same content-cardIcon/content-cardTitle/content-cardDescription metadata fields used by Homepage Cards mode.`}},parameters:{docs:{description:{story:`Card mode "Display Cards Icons" switches the grid to bordered icon + title + description cards -- same box styling as Display Cards mode, but an icon in place of an image and no tag/date/action-link elements at all.`},source:{code:B,language:`html`,type:`code`}}}},H={cardMode:`Homepage Cards`,assets:[`matrix-asset://ntg/2101`,`matrix-asset://ntg/2102`,`matrix-asset://ntg/2103`,`matrix-asset://ntg/2104`,`matrix-asset://ntg/2105`]},Se=await D.markup(H,O),U={render:()=>D(H,O),argTypes:{cardMode:{control:`radio`,options:[`Display Cards`,`Display Cards Icons`,`Homepage Cards`,`Mini Cards`,`News Cards`]},assets:{control:`object`,description:`Array of matrix-asset-uri strings. Icon/title/description are read from the same content-cardIcon/content-cardTitle/content-cardDescription metadata fields used by Display Cards mode.`}},parameters:{docs:{description:{story:'Card mode "Homepage Cards" switches the grid to icon + title + dotted-divider + description items, no card border/background -- same responsive 3/2/1-column layout as the other two modes, same `assets` field.'},source:{code:Se,language:`html`,type:`code`}}}},W={cardMode:`Mini Cards`,assets:[`matrix-asset://ntg/3101`,`matrix-asset://ntg/3102`,`matrix-asset://ntg/3103`]},Ce=await D.markup(W,O),G={render:()=>D(W,O),argTypes:{cardMode:{control:`radio`,options:[`Display Cards`,`Display Cards Icons`,`Homepage Cards`,`Mini Cards`,`News Cards`]},assets:{control:`object`,description:`Array of matrix-asset-uri strings. Icon is read from the asset's "Icon" metadata field (a Font Awesome classic/thin name without the "fa-" prefix); label is the asset name; href is the asset url.`}},parameters:{docs:{description:{story:'Card mode "Mini Cards" switches the grid to asset-derived icon + label link items, in the same responsive 3/2/1-column layout as "Page" mode -- same `assets` field, different rendering.'},source:{code:Ce,language:`html`,type:`code`}}}},K={cardMode:`Mini Cards`,assets:[`matrix-asset://ntg/3101`,`matrix-asset://ntg/3104`]},we=await D.markup(K,O),q={render:()=>D(K,O),parameters:{docs:{description:{story:`An asset with no url renders as a non-interactive div instead of a link; an asset with no Icon metadata value simply omits the icon markup -- both degrade gracefully rather than erroring.`},source:{code:we,language:`html`,type:`code`}}}},J={cardMode:`News Cards`,assets:[`matrix-asset://ntg/4101`,`matrix-asset://ntg/4102`,`matrix-asset://ntg/4103`],layoutOptions:{sectionHeading:`What we are doing`,viewAllButton:{text:`View all`,url:`/news`}}},Te=await D.markup(J,O),Y={render:()=>D(J,O),argTypes:{cardMode:{control:`radio`,options:[`Display Cards`,`Display Cards Icons`,`Homepage Cards`,`Mini Cards`,`News Cards`]},assets:{control:`object`,description:`Array of matrix-asset-uri strings. Rendered newest-first by news-datePublished, regardless of selection order -- try reordering these three demo URIs, the rendered order stays the same.`},layoutOptions:{control:`object`}},parameters:{docs:{description:{story:'Card mode "News Cards" defaults `layoutOptions.showSectionHeader` on, wrapping the grid in an editable heading and "View all" button (both blank/unresolved by default in every other mode), and sorts the selected assets newest-first by news-datePublished. The three demo assets are deliberately selected out of date order to demonstrate the sort.'},source:{code:Te,language:`html`,type:`code`}}}},X={cardMode:`Display Cards Icons`,assets:[`matrix-asset://ntg/6101`,`matrix-asset://ntg/6102`,`matrix-asset://ntg/6103`],layoutOptions:{showSectionHeader:!0,sectionHeading:`Get help with`}},Z=await D.markup(X,O),Q={render:()=>D(X,O),argTypes:{cardMode:{control:`radio`,options:[`Display Cards`,`Display Cards Icons`,`Homepage Cards`,`Mini Cards`,`News Cards`]},layoutOptions:{control:`object`}},parameters:{docs:{description:{story:"`layoutOptions.showSectionHeader` is off by default outside News Cards, but can be turned on for any mode -- here on Display Cards Icons, with only a heading configured (no `viewAllButton`, so the button is simply omitted)."},source:{code:Z,language:`html`,type:`code`}}}},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
  ...
  parameters: {
    docs: {
      description: {
        story: 'Card mode "News Cards" defaults \`layoutOptions.showSectionHeader\` on, wrapping the grid in an editable heading and "View all" button (both blank/unresolved by default in every other mode), and sorts the selected assets newest-first by news-datePublished. The three demo assets are deliberately selected out of date order to demonstrate the sort.'
      },
      source: {
        code: newsCardsHtml,
        language: 'html',
  ...
  parameters: {
    docs: {
      description: {
        story: '\`layoutOptions.showSectionHeader\` is off by default outside News Cards, but can be turned on for any mode -- here on Display Cards Icons, with only a heading configured (no \`viewAllButton\`, so the button is simply omitted).'
      },
      source: {
...
}`,...Q.parameters?.docs?.source}}},$=[`SinglePage`,`MultiplePages`,`Unresolvable`,`DisplayCardsIcons`,`HomepageCards`,`MiniCards`,`MiniCardsNoLink`,`NewsCards`,`DisplayCardsIconsWithHeading`]}))();export{V as DisplayCardsIcons,Q as DisplayCardsIconsWithHeading,U as HomepageCards,G as MiniCards,q as MiniCardsNoLink,F as MultiplePages,Y as NewsCards,M as SinglePage,R as Unresolvable,$ as __namedExportsOrder,k as default};
//# sourceMappingURL=card.stories-D2LOslv_.js.map