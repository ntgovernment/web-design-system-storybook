...
<div ${t} class="news-cards">
  <div class="news-cards__header">
    <h2 class="news-cards__title">${c(v)}</h2>
    <a class="button news-cards__view-all" href="${b}">${c(y)}</a>
  </div>
  <div class="card-grid">
    ${e.map(me).join(``)}
  </div>
</div>
`}async function ge(e,t){let n=await re(t),r=Array.isArray(e)?e:[],i=new Set;return[...r,...n].filter(e=>i.has(e)?!1:(i.add(e),!0))}var h,g,_e,_,v,y,b,x,S,C,ve=e((()=>{s(),n(),h=`<svg viewBox="0 0 16 16" width="16" height="16" fill="none" aria-hidden="true" focusable="false"><path d="M3 8h10m0 0-4-4m4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,g=`Find out more`,_e=`file-lines`,_=`News`,v=`What we are doing`,y=`View all`,b=`%globals_site_metadata_site-news^as_asset:asset_url%`,x=`https://nt.gov.au/web-design-system/listings/asset-children-json-feed`,S=`rootId`,C={async main(e={},t={}){let{cardMode:n=`Display Cards`,assets:i=[],parentAsset:a=``}=e,o=await ge(i,a),s=r(`card`,e);return n===`Mini Cards`?`
...
//# sourceMappingURL=card.stories-IFE_gRVe.js.map