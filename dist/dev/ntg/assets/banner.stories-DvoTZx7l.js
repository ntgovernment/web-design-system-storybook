import{n as e}from"./chunk-BVpWp9h4.js";import{r as t,t as n}from"./component.helper-D3WXhhhy.js";import{n as r,t as i}from"./squizStoryRenderer-4zIdV6yt.js";function a(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}function o(e){return e===`primary`?`button`:`button button-${e}`}function s(e){if(!e||e.length===0)return``;let t=e.findIndex(e=>e.isCurrent),n=t>=0?t:e.length-1;return`
...
${r}
    ...
    </svg>`,_={async main(e){let{variant:t=`primary`,title:r=``,description:i=``,descriptionLinkText:o=``,descriptionLinkHref:g=``,ctaText:_=``,ctaHref:v=``,ctaVariant:y,linksHeading:b=``,links:x=[],breadcrumbs:S=[],label:C=``,href:w=``,showDecorative:T}=e||{},E=p.has(t)?t:`primary`,D=E===`secondary`,O=y&&m.has(y)?y:`secondary`,k=T===void 0?!0:!!T,A=[];Array.isArray(S)&&S.length>0?A=S:C&&w&&(A=[{label:C,href:w},{label:`Current page`,isCurrent:!0}]);let j=`banner--${E}`,M=!!b&&h.has(b)&&Array.isArray(x)&&x.length>0,N=l(_,v,O),P=M?d(b,x,D):_?f(N):``;return`
<div ${n(`banner`,e)} class="fullwidth ${j}" data-variant="${E}">
  ${k?u():``}
...
//# sourceMappingURL=banner.stories-DvoTZx7l.js.map