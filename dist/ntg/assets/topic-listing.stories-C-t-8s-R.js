import{n as e}from"./chunk-BVpWp9h4.js";import{t}from"./topic-listing-BF9Nxf9i.js";import{n,t as r}from"./squizStoryRenderer-mGPdhelI.js";import{n as i,t as a}from"./squizInfo.mock-x2sHGyES.js";function o(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}function s(e,t){let n=e?.[t];return Array.isArray(n)&&n[0]||``}function c(e){if(!e)return null;let t=e.metadata||{};return{title:e.name||``,description:s(t,`Description`),href:e.url||``}}function l(e){return String(e?.type??e?.type_name??e?.type_code??``).toLowerCase().includes(`file`)||!!e?.file_type}function u(e){let t=Number(e);return!Number.isFinite(t)||t<=0?``:`${Math.round(t/1024)} KB`}function d(e){return b[String(e??``).toLowerCase()]||x}function f(e){if(!e)return null;let t=e.name||``,n=e.url||``;if(!t)return null;if(l(e)){let r=e.file_type||``,i=u(e.file_size);return{kind:`document`,title:t,href:n,fileType:r,meta:[r.toUpperCase(),i].filter(Boolean).join(` | `),iconClass:d(r)}}let r=s(e.metadata,`Description`);return r?{kind:`child`,title:t,href:n,description:r}:{kind:`link`,title:t,href:n}}async function p(e,t){if(!e||typeof t?.resolveUri!=`function`)return null;try{return c(await t.resolveUri(e))}catch{return null}}async function m(e,t){return!Array.isArray(e)||e.length===0||typeof t?.resolveUri!=`function`?[]:(await Promise.all(e.map(async e=>{if(!e)return null;try{return f(await t.resolveUri(e))}catch{return null}}))).filter(Boolean)}function h(e){if(!e)return``;let t=e.description?`<p class="topic-listing__description">${o(e.description)}</p>`:``,n=e.href?`<a href="${o(e.href)}" class="button button-secondary topic-listing__button">Find out more</a>`:``;return`
      <div class="topic-listing__topic">
        ...
        <li class="topic-listing__item topic-listing__item--child">
          ...
          <p class="topic-listing__child-description">${o(e.description)}</p>
...
`)}
      </ul>`}var b,x,S,C,w=e((()=>{b={pdf:`fa-file-pdf`,doc:`fa-file-word`,docx:`fa-file-word`,ppt:`fa-file-powerpoint`,pptx:`fa-file-powerpoint`,xls:`fa-file-excel`,xlsx:`fa-file-excel`},x=`fa-file`,S={document:v,child:_,link:g},C={async main(e,t){let{topicSource:n=``,linkSources:r=[]}=e||{},i=t?.fns,[a,o]=await Promise.all([p(n,i),m(r,i)]);return a?`
<div class="topic-listing">
  <div class="topic-listing__container">
    <div class="topic-listing__content">${h(a)}${y(o)}
    </div>
  </div>
</div>
`:``}}}));function T({id:e,name:t,description:n}){return{id:String(e),type:`pageStandard`,name:t,url:`https://example.com/pages/${e}`,metadata:n?{Description:[n]}:{},child_count:0}}function E({id:e,name:t,fileType:n,fileSize:r}){return{id:String(e),type:`file`,name:t,url:`https://example.com/assets/${e}.${n}`,file_type:n,file_size:r}}function D(e){return O[e]??null}var O,k,A,j,M,N,P,F,I,L,R,z,B,V;await e((async()=>{r(),a(),t(),w(),O={"matrix-asset://ntg/5001":T({id:5001,name:`Topic title`,description:`A short description about the topic and what the user expect to find here.`}),"matrix-asset://ntg/5101":T({id:5101,name:`Link sample text`}),"matrix-asset://ntg/5102":T({id:5102,name:`Link sample text`}),"matrix-asset://ntg/5201":E({id:5201,name:`This is the document title`,fileType:`pdf`,fileSize:186368}),"matrix-asset://ntg/5202":E({id:5202,name:`This is the document title`,fileType:`docx`,fileSize:186368}),"matrix-asset://ntg/5203":E({id:5203,name:`This is the document title`,fileType:`pptx`,fileSize:186368}),"matrix-asset://ntg/5204":E({id:5204,name:`This is the document title`,fileType:`xlsx`,fileSize:186368}),"matrix-asset://ntg/5301":T({id:5301,name:`Child care subsidies`,description:`Find eligibility criteria, payment schedules, and how to apply.`}),"matrix-asset://ntg/5302":T({id:5302,name:`Support for carers`,description:`Access respite programs, allowances, and local support groups.`}),"matrix-asset://ntg/5303":T({id:5303,name:`Community grants`,description:`Explore funding rounds for local projects and community initiatives.`}),"matrix-asset://ntg/5304":T({id:5304,name:`Parenting resources`,description:`Guidance for early years, school readiness, and family wellbeing.`})},k=n(C.main),A=i({mock:{resolveUri:D}}),j={title:`dxp/Topic Listing`,parameters:{layout:`padded`}},M={topicSource:`matrix-asset://ntg/5001`,linkSources:[`matrix-asset://ntg/5301`,`matrix-asset://ntg/5302`,`matrix-asset://ntg/5303`,`matrix-asset://ntg/5304`]},N=await k.markup(M,A),P={render:e=>k(e,A),args:M,argTypes:{topicSource:{control:`text`,description:`matrix-asset-uri for the main topic page. Only these demo URIs resolve to anything in this Storybook preview (mocked): matrix-asset://ntg/5001 (topic), matrix-asset://ntg/5101, matrix-asset://ntg/5102 (plain-link pages), matrix-asset://ntg/5201-5204 (documents), matrix-asset://ntg/5301-5304 (child-topic pages, each with its own description).`},linkSources:{control:`object`}},parameters:{docs:{description:{story:"`linkSources` resolves to pages that each have their own metadata.Description -- these render as child-topic items (title + description, no bullet), distinct from the plain bulleted links in the Links story."},source:{code:N,language:`html`,type:`code`}}}},F={topicSource:`matrix-asset://ntg/5001`,linkSources:[`matrix-asset://ntg/5101`,`matrix-asset://ntg/5102`,`matrix-asset://ntg/5101`,`matrix-asset://ntg/5102`,`matrix-asset://ntg/5101`,`matrix-asset://ntg/5102`,`matrix-asset://ntg/5101`,`matrix-asset://ntg/5102`,`matrix-asset://ntg/5101`,`matrix-asset://ntg/5102`]},I=await k.markup(F,A),L={render:()=>k(F,A),parameters:{docs:{description:{story:"Every `linkSources` entry resolves to a page -- each renders as a plain bulleted link, in a two-column grid at the `md` breakpoint and up, one column on mobile."},source:{code:I,language:`html`,type:`code`}}}},R={topicSource:`matrix-asset://ntg/5001`,linkSources:[`matrix-asset://ntg/5201`,`matrix-asset://ntg/5202`,`matrix-asset://ntg/5203`,`matrix-asset://ntg/5204`,`matrix-asset://ntg/5201`,`matrix-asset://ntg/5202`,`matrix-asset://ntg/5203`,`matrix-asset://ntg/5204`,`matrix-asset://ntg/5201`,`matrix-asset://ntg/5202`]},z=await k.markup(R,A),B={render:()=>k(R,A),parameters:{docs:{description:{story:"Every `linkSources` entry resolves to a file -- each renders as a document item (file-type icon, bold title, format + size), in a two-column grid at the `md` breakpoint and up, one column on mobile."},source:{code:z,language:`html`,type:`code`}}}},P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
