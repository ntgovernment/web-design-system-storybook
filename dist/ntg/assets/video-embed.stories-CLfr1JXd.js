...
`}}})),l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;await e((async()=>{r(),t(),c(),l=n(s.main),u={title:`dxp/Video Embed`},d={videoUrl:`https://www.youtube.com/watch?v=I0UdJDZnMhs`,includeText:`Yes`,textPosition:`Top`,heading:`Text top`,body:`<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent at sapien id lectus suscipit scelerisque.</p>`},f=await l.markup(d),p={render:e=>l(e),args:d,argTypes:{videoUrl:{control:`text`,description:`YouTube watch link or Vimeo link.`},includeText:{control:`radio`,options:[`Yes`,`No`]},textPosition:{control:`radio`,options:[`Top`,`Bottom`,`Left`,`Right`]},heading:{control:`text`},body:{control:`text`,description:`Raw HTML (FormattedText).`}},parameters:{docs:{source:{code:f,language:`html`,type:`code`}}}},m={videoUrl:`https://www.youtube.com/watch?v=I0UdJDZnMhs`,includeText:`Yes`,textPosition:`Right`,heading:`Text right`,body:`<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent at sapien id lectus suscipit scelerisque.</p>`},h=await l.markup(m),g={render:()=>l(m),parameters:{docs:{source:{code:h,language:`html`,type:`code`}}}},_={videoUrl:`https://www.youtube.com/watch?v=I0UdJDZnMhs`,includeText:`Yes`,textPosition:`Left`,heading:`Text left`,body:`<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent at sapien id lectus suscipit scelerisque.</p>`},v=await l.markup(_),y={render:()=>l(_),parameters:{docs:{source:{code:v,language:`html`,type:`code`}}}},b={videoUrl:`https://www.youtube.com/watch?v=I0UdJDZnMhs`,includeText:`Yes`,textPosition:`Bottom`,heading:`Text bottom`,body:`<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent at sapien id lectus suscipit scelerisque.</p>`},x=await l.markup(b),S={render:()=>l(b),parameters:{docs:{source:{code:x,language:`html`,type:`code`}}}},C={videoUrl:`https://www.youtube.com/watch?v=I0UdJDZnMhs`,includeText:`No`},w=await l.markup(C),T={render:()=>l(C),parameters:{docs:{description:{story:`Include text set to No -- just the video, no heading/body.`},source:{code:w,language:`html`,type:`code`}}}},E={videoUrl:`https://vimeo.com/106097009`,includeText:`Yes`,textPosition:`Right`,heading:`Vimeo example`,body:`<p>This example uses a Vimeo link instead of YouTube.</p>`},D=await l.markup(E),O={render:()=>l(E),parameters:{docs:{source:{code:D,language:`html`,type:`code`}}}},k={videoUrl:`https://example.com/not-a-video`,includeText:`Yes`,textPosition:`Right`,heading:`Text right`,body:`<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent at sapien id lectus suscipit scelerisque.</p>`},A=await l.markup(k),j={render:()=>l(k),parameters:{docs:{description:{story:`A videoUrl that is not a recognized YouTube or Vimeo link falls back to a graceful "Video unavailable" message instead of a broken iframe.`},source:{code:A,language:`html`,type:`code`}}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
