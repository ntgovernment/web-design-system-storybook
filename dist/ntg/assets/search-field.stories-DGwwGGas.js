...
`}}})),l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F;await e((async()=>{r(),t(),c(),l=n(s.main),u={title:`dxp/Search Field`},d={label:`Primary`,placeholder:`Search`,value:``,variant:`primary`,state:`default`,showClear:!0,searchIconLabel:`Search`},f=await s.main(d),p={render:e=>l(e),args:d,argTypes:{label:{control:`text`},placeholder:{control:`text`},value:{control:`text`},variant:{control:`select`,options:[`primary`,`secondary`]},state:{control:`select`,options:[`default`,`hover`,`focus`,`populated`]},showClear:{control:`boolean`},searchIconLabel:{control:`text`}},parameters:{docs:{source:{code:f,language:`html`,type:`code`}}}},m={label:`Primary`,placeholder:`Search`,variant:`primary`,state:`hover`},h=await s.main(m),g={render:()=>l(m),parameters:{docs:{source:{code:h,language:`html`,type:`code`}}}},_={label:`Primary`,placeholder:`Search`,variant:`primary`,state:`focus`},v=await s.main(_),y={render:()=>l(_),parameters:{docs:{source:{code:v,language:`html`,type:`code`}}}},b={label:`Primary`,value:`Text`,placeholder:`Search`,variant:`primary`,state:`populated`,showClear:!0},x=await s.main(b),S={render:()=>l(b),parameters:{docs:{source:{code:x,language:`html`,type:`code`}}}},C={label:`Secondary`,placeholder:`Search`,variant:`secondary`,state:`default`},w=await s.main(C),T={render:()=>l(C),parameters:{docs:{source:{code:w,language:`html`,type:`code`}}}},E={label:`Secondary`,placeholder:`Search`,variant:`secondary`,state:`hover`},D=await s.main(E),O={render:()=>l(E),parameters:{docs:{source:{code:D,language:`html`,type:`code`}}}},k={label:`Secondary`,placeholder:`Search`,variant:`secondary`,state:`focus`},A=await s.main(k),j={render:()=>l(k),parameters:{docs:{source:{code:A,language:`html`,type:`code`}}}},M={label:`Secondary`,value:`Text`,placeholder:`Search`,variant:`secondary`,state:`populated`,showClear:!0},N=await s.main(M),P={render:()=>l(M),parameters:{docs:{source:{code:N,language:`html`,type:`code`}}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
