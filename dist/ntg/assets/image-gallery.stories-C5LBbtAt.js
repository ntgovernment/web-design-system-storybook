...
`}}}));function v({id:e,name:t,alt:n}){return{type:`type_image`,name:t,alt:n,caption:t,imageVariations:{original:{url:`https://picsum.photos/id/${e}/640/480`,width:640,height:480,mimeType:`image/jpeg`,byteSize:65536,sha1Hash:`${e}aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa`.slice(0,40),aspectRatio:`4:3`}}}}function y(e){return b[e]??null}var b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H;await e((async()=>{r(),a(),t(),_(),b={"matrix-asset://demo-single-image":v({id:1015,name:`Mountain Serenity`,alt:`Scenic mountain landscape with gradient sky and green fields`}),"matrix-asset://demo-single-image-2":v({id:1016,name:`Urban Exploration`,alt:`Urban scene with grey tones and industrial elements`}),"matrix-asset://demo-folder":{type:`type_folder`,name:`Demo Gallery Folder`,children:[1015,1016,1018,1019,1021,1024,1027,1035].map((e,t)=>v({id:e,name:`Image ${t+1}`,alt:`Gallery demonstration image ${t+1}`}))},"matrix-asset://demo-empty-folder":{type:`type_folder`,name:`Empty Folder`,children:[]}},x=n(g.main),S=i({mock:{resolveUri:y}}),C={title:`dxp/Image Gallery`},w={imageSources:[`matrix-asset://demo-single-image`]},T=await x.markup(w,S),E={render:e=>x(e,S),args:w,argTypes:{imageSources:{control:`object`,description:`Array of matrix-asset-uri strings, each a single image or a folder. Only these demo URIs resolve to anything in this Storybook preview (mocked): matrix-asset://demo-single-image, matrix-asset://demo-single-image-2, matrix-asset://demo-folder, matrix-asset://demo-empty-folder.`}},parameters:{docs:{description:{story:`imageSources has one entry pointing directly at a single image asset -- the gallery shows just that one image.`},source:{code:T,language:`html`,type:`code`}}}},D={imageSources:[`matrix-asset://demo-single-image`,`matrix-asset://demo-single-image-2`]},O=await x.markup(D,S),k={render:()=>x(D,S),parameters:{docs:{description:{story:`imageSources has two individually-picked image entries -- no folder involved. Demonstrates that the field supports selecting several images directly, not just one.`},source:{code:O,language:`html`,type:`code`}}}},A={imageSources:[`matrix-asset://demo-folder`]},j=await x.markup(A,S),M={render:()=>x(A,S),parameters:{docs:{description:{story:`imageSources has one entry pointing at a folder; every image resolved as a child of that folder is rendered in the grid.`},source:{code:j,language:`html`,type:`code`}}}},N={imageSources:[`matrix-asset://demo-single-image`,`matrix-asset://demo-folder`]},P=await x.markup(N,S),F={render:()=>x(N,S),parameters:{docs:{description:{story:`imageSources combines one individually-picked image with one folder -- the gallery is the union of both (the individual image plus every image in the folder).`},source:{code:P,language:`html`,type:`code`}}}},I={imageSources:[`matrix-asset://demo-empty-folder`]},L=await x.markup(I,S),R={render:()=>x(I,S),parameters:{docs:{description:{story:`A folder with no images resolves to an empty gallery grid, not an error.`},source:{code:L,language:`html`,type:`code`}}}},z={imageSources:[`matrix-asset://does-not-exist`]},B=await x.markup(z,S),V={render:()=>x(z,S),parameters:{docs:{description:{story:`A source that fails to resolve at all contributes nothing, rendering an empty gallery rather than throwing.`},source:{code:B,language:`html`,type:`code`}}}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
