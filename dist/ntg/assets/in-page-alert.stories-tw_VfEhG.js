...
`}}})),c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C;await e((async()=>{r(),t(),s(),c=n(o.main),l={title:`dxp/In-page Alert`},u=`Callout content. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam ac nunc neque. Praesent posuere lobortis purus, ac laoreet est volutpat in.`,d={alertType:`info`,title:`Information alert`,message:u},f=await c.markup(d),p={render:e=>c(e),args:d,argTypes:{alertType:{control:`select`,options:[`info`,`success`,`warning`,`danger`]},title:{control:`text`},message:{control:`text`}},parameters:{docs:{description:{story:`Default alert type -- blue accent and outline, info icon.`},source:{code:f,language:`html`,type:`code`}}}},m={alertType:`success`,title:`Success alert`,message:u},h=await c.markup(m),g={render:()=>c(m),parameters:{docs:{description:{story:`Green accent and outline, check-circle icon.`},source:{code:h,language:`html`,type:`code`}}}},_={alertType:`warning`,title:`Warning alert`,message:u},v=await c.markup(_),y={render:()=>c(_),parameters:{docs:{description:{story:`Orange accent and outline, warning-triangle icon.`},source:{code:v,language:`html`,type:`code`}}}},b={alertType:`danger`,title:`Danger alert`,message:u},x=await c.markup(b),S={render:()=>c(b),parameters:{docs:{description:{story:`Red accent and outline, cross-circle icon.`},source:{code:x,language:`html`,type:`code`}}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
