import{n as e}from"./chunk-BVpWp9h4.js";var t=e((()=>{})),n,r,i,a,o,s,c;e((()=>{t(),n={title:`CSS Components/Forms/Input`},r=({type:e,placeholder:t=`Placeholder text`,value:n=``,className:r=``,readonly:i=!1,disabled:a=!1,success:o=!1,error:s=!1,dataClear:c=!1})=>{let l=[r,o?`--success`:``,s?`--error`:``].filter(Boolean).join(` `),u={date:`2026-07-21`,"datetime-local":`2026-07-21T09:30`,datetime:`2026-07-21T09:30`,email:`name@example.com`,month:`2026-07`,number:`1`,password:`P@ssword123`,tel:`0400000000`,time:`09:30`,url:`https://example.com`,week:`2026-W30`},d=``;return n&&(d=u[e]??n),`
        ...
        />
    `},i={args:{otherTypes:`email`},argTypes:{otherTypes:{control:`select`,options:[`email`,`tel`,`number`,`password`,`url`,`search`,`date`,`time`,`datetime-local`,`month`,`week`]}},render(e){return requestAnimationFrame(()=>{window.__ntgds__.run(`clearableInputs`)}),`
        <style>
            td input {
                width: 100%;
            }
    ...
    <table class="story">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ${r({type:`text`,dataClear:!0})}
                </td>
                <td>
                    ${r({type:e.otherTypes,dataClear:!0})}
                </td>
            </tr>
            <tr>
                <th><code>:hover</code> / <code>.--hover</code> (Empty)</th>
                <td>
                    ${r({type:`text`,className:`--hover`})}
                </td>
                <td>
                    ${r({type:e.otherTypes,className:`--hover`})}
                </td>
            </tr>
            <tr>
                <th><code>:focus</code> / <code>.--focus</code> (Empty)</th>
                <td>
                    ${r({type:`text`,className:`--focus`})}
                </td>
                <td>
                    ${r({type:e.otherTypes,className:`--focus`})}
                </td>
            </tr>
            <tr>
                <th><code>:focus</code> / <code>.--focus</code> (Filled)</th>
                <td>
                    ${r({type:`text`,className:`--focus`,value:`Input text`,placeholder:``})}
                </td>
                <td>
                    ${r({type:e.otherTypes,className:`--focus`,value:`Input text`,placeholder:``})}
                </td>
            </tr>
            <tr>
                <th>Enabled (Filled)</th>
                <td>
                    ${r({type:`text`,value:`Input text`,placeholder:``})}
                </td>
                <td>
                    ${r({type:e.otherTypes,value:`Input text`,placeholder:``})}
                </td>
            </tr>
            <tr>
                <th><code>.--success</code> (Empty)</th>
                <td>
                    ${r({type:`text`,success:!0})}
                </td>
                <td>
                    ${r({type:e.otherTypes,success:!0})}
                </td>
            </tr>
            <tr>
                <th><code>.--success</code> (Filled)</th>
                <td>
                    ${r({type:`text`,success:!0,value:`Input text`,placeholder:``})}
                </td>
                <td>
                    ${r({type:e.otherTypes,success:!0,value:`Input text`,placeholder:``})}
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ${r({type:e.otherTypes,error:!0})}
                </td>
            </tr>
            <tr>
                <th><code>.--error</code> (Filled)</th>
                <td>
                    ${r({type:`text`,error:!0,value:`Input text`,placeholder:``})}
                </td>
                <td>
                    ${r({type:e.otherTypes,error:!0,value:`Input text`,placeholder:``})}
                </td>
            </tr>
            <tr>
                <th><code>[readonly]</code> (Idle)</th>
                <td>
                    ${r({type:`text`,readonly:!0,value:`Input text`,placeholder:``})}
                </td>
                <td>
                    ${r({type:e.otherTypes,readonly:!0,value:`Input text`,placeholder:``})}
                </td>
            </tr>
            <tr>
                <th><code>[readonly]</code> + <code>.--focus</code> (Focus)</th>
                <td>
                    ${r({type:`text`,readonly:!0,className:`--focus`,value:`Input text`,placeholder:``})}
                </td>
                <td>
                    ${r({type:e.otherTypes,readonly:!0,className:`--focus`,value:`Input text`,placeholder:``})}
                </td>
            </tr>
            <tr>
                <th><code>[disabled]</code> (Empty)</th>
                <td>
                    ${r({type:`text`,disabled:!0,placeholder:`Disabled text`})}
                </td>
                <td>
                    ${r({type:e.otherTypes,disabled:!0,placeholder:`Disabled text`})}
                </td>
            </tr>
        </tbody>
    </table>
  ...
  render: () => \`
    ...
    \`
}`,...s.parameters?.docs?.source}}},c=[`Input`,`Checkbox`,`Radio`,`InputButtons`]}))();export{a as Checkbox,i as Input,s as InputButtons,o as Radio,c as __namedExportsOrder,n as default};